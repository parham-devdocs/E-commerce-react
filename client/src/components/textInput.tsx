...
const TextInput = ({ type, id,autoComplete, placeHolder, ...props }: { placeHolder: string,  autoComplete?: React.HTMLInputAutoCompleteAttribute    , id: string, type: "text" | "email" | "password" }) => {
